        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FieldName = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemFields_InventoryFields_FieldId",
                        column: x => x.FieldId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryFields_InventoryId_FieldName",
                table: "InventoryFields",
                columns: new[] { "InventoryId", "FieldName" },
                unique: true);
